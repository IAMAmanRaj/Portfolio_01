const TermsandConditions = () => {
  return (
    <div className="h-[100vh] overflow-y-scroll pb-4 w-full bg-gray-950 text-blue-500  flex flex-col justify-between gap-8 items-center pt-24 ">
      <h1 className="roboto text-2xl lg:-5xl font-bold  ">
        Terms & Conditions
      </h1>
      <div className="max-w-4xl   text-left">
        ...
        <ul className="list-disc pl-8">
          ...
          <li>
            ...
            document without AMAN RAJ’s prior written consent.
          </li>
          <li>
            Any dispute arising out of the use of our website and/or purchase
            with us and/or any engagement with us is subject to the laws of
            India.
          </li>
          <li>
